  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <section class="py-4 border-b border-slate-100 dark:border-slate-700">
      <a href="{{ route('marcas.create') }}"
        class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded text-sm">Crear Marca</a>
    </section>
            ...
            <tbody>
              ...
              @foreach ($marcas as $item)
                <tr>
                  <td>{{ $item->name }}</td>
                  <td>
                    <div><img class="w-40 h-16 object-contain" src="{{ asset($item->description) }}"
                        onerror="this.onerror=null;this.src='/images/img/noimagen.jpg';" /></div>
                  </td>
    ...
    $('document').ready(function() {
      ...
      $(document).on('click', '.btn_delete', function(e) {
        ...
        Swal.fire({
          ...
          text: "Vas a eliminar una Marcas",
          icon: "warning",
