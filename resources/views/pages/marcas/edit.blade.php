            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 ">
                  ...
                  <input type="text" id="name" name="name" value="{{ $marca->name }}"
              ...
              <div class="md:col-span-5">
                <label>Imagen de marca actual</label>
                <div class="relative mb-2 mt-2">
                  <img src="{{ asset($marca->description) }}"
              ...
              <div class="md:col-span-5">
                <label for="description">Imagen de marca</label>
                <div class="relative mb-2  mt-2">
