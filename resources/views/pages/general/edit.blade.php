                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1">
                      ...
                      <div class="lg:col-span-1">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                          ...
                          <div class="md:col-span-5">
                            <label for="schedule">Titulo destacados</label>
                            <div class="relative mb-2">
                              <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div class="md:col-span-5">
                            <label for="schedule">Titulo liquidacion</label>
                            <div class="relative mb-2">
                              <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <h2 class="md:col-span-5 text-lg font-semibold text-slate-800 mt-4 dark:text-white">
                          ...
                          <div class="md:col-span-5">
                            ...
                            <div class="relative mb-2">
                              ...
                              <input type="text" id="meta_title" name="meta_title" value="{{ $general->meta_title ?? '' }}"
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          ...
                          <div class="md:col-span-5">
                            ...
                            <div class="relative mb-2">
                              ...
                              <textarea id="meta_description" name="meta_description" rows="3" 
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Descripción para motores de búsqueda (150-160 caracteres)" maxlength="160">{{ $general->meta_description ?? '' }}</textarea>
                            </div>
                          </div>

                          <div class="md:col-span-5">
                            <label for="meta_keywords">Palabras clave (Meta Keywords)</label>
                            <div class="relative mb-2">
                              <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <input type="text" id="meta_keywords" name="meta_keywords" value="{{ $general->meta_keywords ?? '' }}"
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          ...
                          <div class="md:col-span-5">
                            <label for="og_title">Título para redes sociales (Open Graph Title)</label>
                            <div class="relative mb-2">
                              <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <input type="text" id="og_title" name="og_title" value="{{ $general->og_title ?? '' }}"
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Título cuando se comparte en redes sociales">
                            </div>
                          </div>

                          <div class="md:col-span-5">
                            <label for="og_description">Descripción para redes sociales (Open Graph Description)</label>
                            <div class="relative mb-2">
                              <div class="absolute top-3 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor"
                                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <textarea id="og_description" name="og_description" rows="2" 
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Descripción cuando se comparte en redes sociales">{{ $general->og_description ?? '' }}</textarea>
                            </div>
                          </div>

                          <div class="md:col-span-5">
                            <label for="og_image" class="cursor-pointer">Imagen para redes sociales (Open Graph Image)</label>
                            <div class="relative mb-2">
                              <div class="absolute inset-y-0 left-0 flex items-center pointer-events-none">
                                <img src="{{ $general->og_image ?? '/images/img/noimagen.jpg' }}?={{ uniqid() }}"
                                  class="w-10 h-10 object-cover object-center rounded-s-lg"
                                  onerror="this.onerror = null; this.src = '/images/img/noimagen.jpg';">
                              </div>
                              <input type="file" id="og_image" name="og_image"
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-pointer"
                                accept="image/*">
                            </div>
                          </div>
                          ...
                          <div class="md:col-span-5">
                            ...
                            <div class="relative mb-2">
                              ...
                              <input type="text" id="canonical_url" name="canonical_url" value="{{ $general->canonical_url ?? '' }}"
                                class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
