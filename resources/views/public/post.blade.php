        ...
        <section class="w-11/12 md:w-10/12 mx-auto pt-5">
            ...
            <div class="flex flex-col gap-10">
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-[#0051FF] font-moderat_700 text-text16 md:text-text20">Categoría - Fecha</p>
                </div>
                ...
                <div class="flex flex-col gap-4">
                    <p class="text-[#565656] text-text18 md:text-text22 font-moderat_400">
                ...
                <div class="flex flex-wrap gap-4 justify-center text-text18 md:text-text22 my-10">
                    <p
            ...
            <div class="flex flex-col gap-10 py-10 border-b-2 border-[#565656]">
            ...
            <div class="flex flex-col gap-2 py-10">
                <p class="font-moderat_700 text-[#0051FF] text-text16">Compartir</p>
