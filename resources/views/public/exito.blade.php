...
@section('content')
  <main>
    <section class="mt-5 mb-10 w-11/12 mx-auto">
      ...
      <div class="flex flex-col justify-start gap-5 md:gap-10 max-w-[700px] mx-auto pt-10 text-center">
        <div class="flex flex-col gap-4 justify-center items-center">
          ...
          <p data-aos="fade-up" data-aos-offset="150" class="font-moderat_700 text-text16 md:text-text20 text-[#141718]">
        ...
        <div class="flex flex-col gap-5">
          {{-- <div data-aos="fade-up" data-aos-offset="150"
            ...
            <div class="w-full basis-5/12">
              <p class="font-moderat_Bold text-text14 xl:text-text18 text-[#141718] text-left py-4">
                Producto
              </p>
              ...
              <div class="flex justify-start md:justify-center items-center gap-5">
                <div class="h-full w-full flex justify-center basis-1/3 md:basis-1/2 items-center bg-[#F3F3F3] py-8 px-3">
                  <img src="{{ asset('images/img/image_52.png') }}" alt="producto" class="w-[75] h-[48px]" />
                </div>
            ...
            <div class="flex gap-10 w-full text-center basis-7/12">
              <div class="flex-1">
                <p class="font-moderat_Bold text-text14 md:text-text18 text-[#141718] pt-4 pb-6">
                  Cantidad
                </p>

                <div class="flex justify-center text-[#151515] md:pt-8">
                  <div class="w-8 h-8 flex justify-center items-center flex-1">
                    <span class="font-moderat_Bold text-text14 md:text-text18">2</span>
                  </div>
                </div>
              </div>
              ...
              <div class="flex-1">
                ...
                <p class="font-moderat_Bold text-text14 md:text-text18 text-[#151515] md:pt-8">
                  s/19.00
                </p>
              </div>
          ...
          <div data-aos="fade-up" data-aos-offset="150"
            ...
            <div class="w-full basis-5/12">
              ...
              <div class="flex justify-start md:justify-center items-center gap-5">
                <div
                  class="h-full w-full flex justify-center basis-1/3 md:basis-1/2 items-center bg-[#F3F3F3] py-8 px-3">
                  <img src="{{ asset('images/img/image_52.png') }}" alt="producto" class="w-[75] h-[48px]" />
                </div>
...
@section('scripts_importados')
  ...
  <script>
    ...
    function pintarCantidadexito() {
      let carritoexito = Local.get('carrito')
      console.log('header exito', carritoexito)

      if (typeof carritoexito !== 'undefined' && carritoexito !== null) {
        console.log('diferente a nulo')
        // La variable carritoexito está definida y no es null
        total = carritoexito.length
        if (total == 0) {
