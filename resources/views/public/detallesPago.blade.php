    ...
    <main>
        <section class="w-11/12 mx-auto mt-5 mb-10 flex flex-col gap-10">
            ...
            <div class="flex flex-col lg:flex-row lg:gap-44">
                    ...
                    <div class="flex flex-col gap-5">
                        <div>
                            <div class="flex flex-col gap-8">
                                <div class="flex flex-col gap-5 pb-10 border-b-2 border-[#565656]" data-aos="fade-up" data-aos-offset="150">
                                            ...
                                            <div class="flex flex-col gap-2 z-[45]" data-aos="fade-up" data-aos-offset="150">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="dropdown w-full">
                                                        <div
                                                            class="input-box focus:outline-none font-moderat_Regular text-text16 md:text-text18 mr-20 text-[#6C7275] border-[1.5px] border-gray-200  py-6 px-4">
                                            ...
                                            <div class="flex flex-col gap-2 z-[40]" data-aos="fade-up" data-aos-offset="150">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="dropdown-provincia w-full">
                                                        <div
                                                            class="input-box-provincia focus:outline-none font-moderat_Regular text-text16 md:text-text18 mr-20 text-[#6C7275] border-[1.5px] border-gray-200 py-6 px-4">
                                            ...
                                            <div class="flex flex-col gap-2 z-[30]" data-aos="fade-up" data-aos-offset="150">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="dropdown-distrito w-full">
                                                        <div
                                                            class="input-box-distrito focus:outline-none font-moderat_Regular text-text16 md:text-text18 mr-20 text-[#6C7275] border-[1.5px] border-gray-200 py-6 px-4">
                                ...
                                <div class="flex flex-col gap-5 pb-10" data-aos="fade-up" data-aos-offset="150">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center ps-4 border border-gray-200" data-aos="fade-up" data-aos-offset="150">
                                        ...
                                        <div class="deposito__cuenta hidden">
                                            <div class="flex justify-between items-center text-[#6C7275] px-16 voucher">
                                                ...
                                                <div>
                                                    <label for="upload"
                                                        class="font-moderat_Bold text-text12 cursor-pointer">Envía tu
                                                        comprobante</label>
                ...
                <div class="basis-5/12 flex flex-col justify-start gap-10 pt-5 md:pt-0" data-aos="fade-up" data-aos-offset="150">
                    ...
                    <div>
                        <div class="flex flex-col gap-10">
                            <div class="flex justify-between border-b-[1px] border-[#E8ECEF] pb-5" data-aos="fade-up" data-aos-offset="150">
                        ...
                        <div class="flex flex-col gap-5 mt-10">
                            <div
                                class="text-[#141718] flex justify-between items-center border-b-[1px] border-[#E8ECEF] pb-5 text-text16 md:text-text18" data-aos="fade-up" data-aos-offset="150">
                                <p class="font-moderat_Regular">Envío</p>
                                <p class="font-moderat_Bold">Gratis</p>
                            </div>

                            <div
                                class="text-[#141718] flex justify-between items-center border-b-[1px] border-[#E8ECEF] pb-5 text-text16 md:text-text18" data-aos="fade-up" data-aos-offset="150">
                                <p class="font-moderat_Regular">Subtotal</p>
                                <p class="font-moderat_Bold">s/ 99.00</p>
                            </div>

                            <div
                                class="text-[#141718] font-moderat_Medium text-text20 xl:text-text22 flex justify-between items-center pb-5" data-aos="fade-up" data-aos-offset="150"> 
                                <p>Total</p>
                                <p>s/ 234.00</p>
                            </div>
                        </div>
