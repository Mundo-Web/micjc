...
@section('content')
    ...
    <main>
        <section class="w-11/12 mx-auto">
            <div class="bg-[#0051FF] py-5 fondo__contacto-desktop mt-5" {{-- style="background-image: url({{asset('images/img/image_16.png')}}); background-repeat: no-repeat; background-size:cover;" --}}>
                <div class="grid grid-cols-1 md:grid-cols-2" data-aos="fade-up" data-aos-offset="150">
                    <div
                        class="flex flex-col justify-center gap-5 order-1 md:order-2 px-5 md:z-50 md:-mx-[90px] w-full lg:w-11/12">
                        <h1 class="text-text40 md:text-text48 font-moderat_700 text-white leading-[56px] md:leading-tight">
                            Contacto</h1>
                        <p class="text-white text-text14 font-moderat_Regular w-full md:w-5/6 hidden md:block">Escríbenos</p>

                        <div class="flex md:hidden justify-start items-center">
                            <a href="#" class="flex justify-center items-center gap-2">
                                <span class="text-white text-text16 font-moderat_Bold">Conversar</span>
                                <div>
                    ...
                    <div class="flex justify-end md:justify-end  items-center py-10 md:py-0 order-2 md:order-1 relative lg:z-10 pr-5"
                        ...
                        <img src="{{ asset('images/svg/image_18.svg') }}" alt="impresora"
                            class="w-[200px] h-[200px] md:w-[300px] md:h-[450px]">
                        ...
                        <img src="{{ asset('images/img/image_58.png') }}" alt="impresora"
                            class="hidden md:block absolute mr-24 w-[254px] h-[257px]">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <form action="" id="formContactos" class="flex flex-col gap-5" data-aos="fade-up"
                        ...
                        <div class="w-full">
                            <input required type="text" id="full_name" name="full_name" placeholder="Nombre completo"
                                class="border-b-[1.5px] border-[#082252] border-t-0 border-l-0 border-r-0 w-full focus:outline-none focus:border-transparent font-moderat_Regular text-text16 md:text-text18 py-3 focus:ring-black">
                        </div>
                        ...
                        <div class="flex justify-center items-center pt-3">
                            <button type="submit"
                                class="font-moderat_Bold text-text16 md:text-text18 text-white py-3 px-10 bg-[#0051FF] w-full text-center hover:bg-sky-800 md:duration-300">
                                Enviar Solicitud
                            </button>
                        </div>
