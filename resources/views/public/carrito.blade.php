            ...
            <div data-aos="fade-up" data-aos-offset="150">
              ...
              >
                <div class="w-full basis-5/12">
                  <p
                    class="font-moderat_Bold text-text14 xl:text-text16 text-[#141718] text-left py-4"
                  >
                    Producto
                  </p>
                  ...
                  <div class="flex justify-start items-center gap-5 w-full">
                    ...
                    <div class="flex flex-col justify-start items-start w-full gap-1 md:gap-2">
                      ...
                      <p
                        class="font-moderat_Regular text-text12 xl:text-text14 text-[#6C7275]"
                      >
                        Color: Black
                      </p>
                      <div
                ...
                <div class="flex gap-5 w-full text-center basis-7/12">
                  <div class="flex-1">
                    <p
                      class="font-moderat_Bold text-text14 xl:text-text16 text-[#141718] pt-4 pb-6 lg:pb-14"
                    >
                      Cantidad
                    </p>

                    <div>
                        <input type="number" class="border-2 rounded-lg w-16 h-8 font-moderat_Regular" value="01" step="1">
                    </div>
                  </div>
                  ...
                  <div class="flex-1">
                    ...
                    <p
                      class="font-moderat_Bold text-text18 xl:text-text20 text-[#151515]"
                    >
                      S/<span>19.00</span> 
                    </p>
                  </div>
            ...
            <div>
              <div class="flex flex-col gap-5">
                <div class="w-full flex flex-col gap-5">
                  ...
                  >
                    ...
                    <label
                      ...
                      class="w-full py-4 ms-2 text-text16 xl:text-text18 font-moderat_Regular text-[#151515] flex justify-between items-center px-4"
                    >
                ...
                >
                  ...
                  <span class="font-moderat_Bold">s/ 114.00</span>
                </div>

                <div data-aos="fade-up" data-aos-offset="150" 
                  class="text-[#151515] flex justify-between items-center text-text20 xl:text-text22"
                >
                  <p class="font-moderat_Bold">Total</p>
                  <span class="font-moderat_Bold">s/ 114.00</span>
                </div>

                <a data-aos="fade-up" data-aos-offset="150" 
