<footer class="bg-[#0051FF] py-20">
  <div class="grid grid-cols-1 lg:grid-cols-4 text-white w-11/12 mx-auto gap-12" data-aos="fade-up" data-aos-offset="150">
    ...
    <div class="flex flex-col gap-5">
      ...
      <a href="/politica_privacidad" class="font-Montserrat_Regular text-text12 md:text-text14">Políticas de privacidad</a>
      <a href="/term_condiciones" class="font-Montserrat_Regular text-text12 md:text-text14">Términos y condiciones</a>
      <a href="/libro-de-reclamaciones" class="font-Montserrat_Regular text-text12 md:text-text14">Libro de
        Reclamaciones</a>
      {{-- <a href="/politicas-de-devolucion" class="font-Montserrat_Regular text-text12 md:text-text14">Políticas de
        devolución</a> --}}
    </div>

    <div class="flex flex-col gap-5">
      <p class="underline font-moderat_500 text-text14 md:text-text16">Menú</p>
      <a href="{{ route('index') }}" class="font-Montserrat_Regular text-text12 md:text-text14">Inicio</a>
      <a href="{{ route('index') }}" class="font-Montserrat_Regular text-text12 md:text-text14">Nosotros</a>
      <a href="{{ route('catalogo') }}" class="font-Montserrat_Regular text-text12 md:text-text14">Productos</a>
      <a href="{{ route('blog', 0) }}" class="font-Montserrat_Regular text-text12 md:text-text14">Blog</a>
      <a href="{{ route('contacto') }}" class="font-Montserrat_Regular text-text12 md:text-text14">Contáctanos</a>
    </div>
